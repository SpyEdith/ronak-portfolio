      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 md:grid-cols-2">
        ...
        >
          <div className="relative h-80 w-80">
            ...
            <div className="absolute left-1/2 top-1/2 flex h-28 w-28 -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-purple-400/30 bg-white/5 shadow-2xl shadow-purple-500/20 backdrop-blur-md items-center justify-center">
